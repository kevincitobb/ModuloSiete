...
import dgitc.unam.modulosiete.databinding.ActivityMainSonidoBinding
import java.io.File

class MainActivitySonido : AppCompatActivity() {
    private lateinit var archivos: ArrayList<ModeloSonido>
    private lateinit var binding: ActivityMainSonidoBinding
    private lateinit var adap: RecipeAdapterSonido
    private var mediaPlayer: MediaPlayer? = null
    private var indice: Int = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMainSonidoBinding.inflate(layoutInflater)
        ...
        if (stadoSD == Environment.MEDIA_MOUNTED) {
            ...
            archivos.add(ModeloSonido("Magenta_Moon_Part_II.mp3",R.drawable.musica_img,
